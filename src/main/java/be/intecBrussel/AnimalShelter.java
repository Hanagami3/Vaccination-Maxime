...
public class AnimalShelter {
    ...
    public void sortAnimal(){
        animals = animals.stream().sorted(Animal::compareTo)
                .toList();
    }

    public void sortAnimalsByName(){
        animals = animals.stream().sorted(Comparator.comparing(a -> a.getName()))
                .toList();
    }

    public void sortAnimalsByAge(){
        animals = animals.stream().sorted(Comparator.comparing(a -> a.getAge()))
                .toList();
    }
